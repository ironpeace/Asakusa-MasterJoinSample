...
/**
 * {@code [in->project(operator#1654792719)]}の処理を担当するマッププログラムの断片。
 */
@TraceLocation(batchId = "MjsBatch", flowId = "MainJobFlow", stageId = "stage0001", fragmentId = "4")@SuppressWarnings(
        "deprecation") public final class MapFragment4 implements Result<JoinedSalesDetail> {
