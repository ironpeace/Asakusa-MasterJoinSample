...
/**
 * {@code [in->padding(pseud#1130907398){owner=FlowBlock&#64;2077652091}]}の処理を担当するマッププログラム。
 */
@TraceLocation(batchId = "MjsBatch", flowId = "MainJobFlow", stageId = "stage0001", stageUnitId = "m2")@SuppressWarnings
        ("deprecation") public final class StageMapper2 extends MapperWithRuntimeResource<NullWritable, ItemMaster, 
