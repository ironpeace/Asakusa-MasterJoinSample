...
/**
 * {@code detail->JoinOperator.joinedData(operator#290885557)}へのシャッフル処理を担当するプログラムの断片。
 */
@SuppressWarnings("deprecation") public final class CombineOutputFragment2 implements Result<SalesDetail> {
