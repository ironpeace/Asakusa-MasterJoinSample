...
@TraceLocation(batchId = "MjsBatch", flowId = "MainJobFlow", stageId = "epilogue.directio") public final class 
    ...
    @Override protected String getStageOutputPath() {
        return "target/hadoopwork/${execution_id}/MjsBatch/MainJobFlow/epilogue/directio";
    }
    @Override protected List<StageInput> getStageInputs() {
        List<StageInput> results = new ArrayList<StageInput>();
        Map<String, String> attributes = null;
        attributes = new HashMap<String, String>();
        results.add(new StageInput("target/hadoopwork/${execution_id}/MjsBatch/MainJobFlow/stage0001/result10-*", 
                TemporaryInputFormat.class, StageMapper0.class, attributes));
        attributes = new HashMap<String, String>();
        results.add(new StageInput("target/hadoopwork/${execution_id}/MjsBatch/MainJobFlow/stage0001/result0-*", 
    ...
    @Override protected List<StageOutput> getStageOutputs() {
        ...
        Map<String, String> attributes = null;
        attributes = new HashMap<String, String>();
        results.add(new StageOutput("mjs-out", NullWritable.class, SalesDetail2.class, BridgeOutputFormat.class, 
                attributes));
        attributes = new HashMap<String, String>();
        results.add(new StageOutput("mjs-error", NullWritable.class, ErrorRecord.class, BridgeOutputFormat.class, 
                attributes));
        return results;
    }
