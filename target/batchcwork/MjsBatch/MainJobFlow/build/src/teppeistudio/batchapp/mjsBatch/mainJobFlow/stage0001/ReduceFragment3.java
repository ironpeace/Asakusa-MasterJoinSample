...
/**
 * {@code [master->JoinOperator.joinedData(operator#290885557), detail->JoinOperator.joinedData(operator#290885557)]}
         * の処理を担当するマッププログラムの断片。
 */
@TraceLocation(batchId = "MjsBatch", flowId = "MainJobFlow", stageId = "stage0001", fragmentId = "3")@SuppressWarnings(
