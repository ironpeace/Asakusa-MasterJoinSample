...
/**
 * CSV format for {@link ItemCategory}.
 */
public final class ItemCategoryCsvFormat extends BinaryStreamFormat<ItemCategory> {
    /**
    ...
    @Override public Class<ItemCategory> getSupportedType() {
    ...
    @Override public ModelInput<ItemCategory> createInput(Class<? extends ItemCategory> dataType, String path, 
    ...
    @Override public ModelOutput<ItemCategory> createOutput(Class<? extends ItemCategory> dataType, String path, 
    ...
    private static final class Reader implements ModelInput<ItemCategory> {
        private final CsvParser parser;
        Reader(CsvParser parser) {
            this.parser = parser;
        }
        @Override public boolean readTo(ItemCategory object) throws IOException {
    ...
    private static final class Writer implements ModelOutput<ItemCategory> {
        private final CsvEmitter emitter;
        Writer(CsvEmitter emitter) {
            this.emitter = emitter;
        }
        @Override public void write(ItemCategory object) throws IOException {
